...
if(isset($_POST['email'])){ 
 ...
 ';
    ...
    $message = "<html>
            ...
            <body><table align='center' style = 'border: 1 px; solid #333;' width = '500'><tr><th>Name</th><th>Email:</th><th>Phone No.</th><th>Question</th></tr><tr><td align='center'>".$_POST['first_name'].' '.$_POST['last_name']."</td><td align='center'>".$_POST['email']."</td><td align='center'>".$_POST['phone']."</td><td align='center'>".$_POST['question']."</td></tr></table></body></html>";
    $from = $_POST['email'];
